...
\begin{enumerate}[label=(\roman*)]
	\item Initialize a Random variable $X$ and equate to 0. Calculate the probability $pp$ for $X=0$ which is $e^{-\lambda} $ from equation \eqref{eq:poissondistributionpmf}.
