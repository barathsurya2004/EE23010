...
\begin{align}
	...
	\implies E\brak{\cond{\frac{1}{1+X}}{X>0}} &=\frac{\sum_{k=1}^{\infty}\frac{1}{k+1}\pr{X=k}}{1-e^{\lambda}}\\
	&=\frac{\sum_{k=1}^{\infty}\frac{1}{k+1} e^{-\lambda}\frac{\lambda^k}{k!}}{1-e^{\lambda}}\\
	&=\frac{e^{-\lambda}\sum_{k=1}^{\infty}\frac{\lambda}{\brak{k+1}!}}{1-e^{\lambda}}
\end{align}
using taylor series expansion of $e$
\begin{align}
	&=\frac{e^{-\lambda}}{\lambda \brak{1-e^{\lambda}}}\brak{\sum_{k=0}^{\infty}\frac{\lambda^k}{k!} -1 -\lambda}\\
